      ...
      try {
        const LawnAnalysisSchema = z.object({
          ...
          treatmentOptions: z.object({
            ...
            chemical: z.array(z.string()).min(2).max(3).describe("Chemical treatment options with specific products or active ingredients. Include timing advice like 'For organic control, pour boiling water directly on each dandelion plant or use a dandelion weeding tool to remove the entire taproot'"),
            cultural: z.array(z.string()).min(2).max(3).describe("Cultural practices and lawn care adjustments like 'Fill any bare spots left behind with St. Augustine grass plugs or seed to prevent new weed establishment'"),
          }),
